...
public class Banco {
    ...
    public static void inicia() throws ParseException{
        ...
        Cliente cliente1 = new Cliente(1, "Guilherme Silva", 'M', "13/01/2007", "30212126", "guilhermeviniciusbispodasilva@gmail.com", "5142487", "Rua jaboti 35 Canudos NH",  "93300012");
        Cliente cliente2 = new Cliente(2, "Emerson Silva", 'F', "30/08/1994", "30212127", "emerligui@gmail.com", "5142487745", "Rua campo bom 78 Centro NH",  "93300045");
        ...
        Servico servico2 = new Servico(2, "Corte Degradê", 30);
        ...
        Agendamento agendamento1 = new Agendamento(1, cliente9, servico6, 0, "28/11/2023", "14:00", "cliente vai atrasar");
        Agendamento agendamento2 = new Agendamento(2, cliente3, servico1, 0, "28/11/2023", "14:00", "cliente vai atrasar");
        Agendamento agendamento3 = new Agendamento(3, cliente5, servico3, 0, "28/11/2023", "14:00", "cliente vai atrasar");
